"""Exercise 5.4. Think Python: If you are given three sticks, you may or may not be able to arrange them in a triangle.
...
print (" This Program Will Check Whether you can make a Triangle with 3 Stick lengths")
d = int (input ("Enter a stick length: \n"))
e = int (input ("Enter a stick length: \n"))
f = int (input ("Enter a stick length: \n"))
